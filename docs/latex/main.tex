...
%% Epígrafe removida: a frase não possuía fonte externa identificável.
...
\include{./PreTexto/declaracao-ia}%% Comente para remover este item
...
%% Lista de Gráficos (não há gráficos no documento)
...
%% Lista de símbolos
\incluirlistadesimbolos{none}%% Não há notação matemática recorrente que justifique uma lista própria
