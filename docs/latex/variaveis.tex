...
\program{Curso de Engenharia de Computação}
...
\author{Pedro F. Leão \\ Lucas P. Flores}  % Seu nome
\authorbib{Leão, Pedro F.; Flores, Lucas P.} % Seu nome para referência bibliográfica (Sobrenome, Nome)
\title{Desenvolvimento de um Sistema de \textit{High-Frequency Trading} de Baixo Custo utilizando HLS em FPGA} % Título do trabalho
\titleen{Development of a Low-Cost High-Frequency Trading System using HLS on FPGA} % Título traduzido para inglês
\advisor{Prof. Carlos Raimundo Erig Lima} % Nome do orientador.
...
\evalboardmember{Prof. Carlos Raimundo Erig Lima}{Orientador}{Universidade Tecnológica Federal do Paraná}
\evalboardmember{Membro da banca a definir}{A definir}{Universidade Tecnológica Federal do Paraná}
\evalboardmember{Prof. Daniel Fernando Pigatto}{Membro da banca}{Universidade Tecnológica Federal do Paraná, Campus Curitiba}
\evalboardmember{Prof. Elder Oroski}{Membro da banca}{Universidade Tecnológica Federal do Paraná, Campus Curitiba}
...
\PalavraChaveA{FPGA}%% Palavra-chave A
\PalavraChaveB{\textit{High-frequency trading}}%% Palavra-chave B
\PalavraChaveC{S\'intese de alto n\'ivel}%% Palavra-chave C
\PalavraChaveD{Order Book}%% Palavra-chave D
...
\KeywordA{FPGA}%% Keyword A
\KeywordB{High-frequency trading}%% Keyword B
\KeywordC{High-level synthesis}%% Keyword C
\KeywordD{Order book}%% Keyword D
\KeywordE{Embedded systems}%% Keyword E
