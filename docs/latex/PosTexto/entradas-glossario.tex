...
\newglossaryentry{orderbook}{%% Informações da entrada
  name        = {Order Book},
  sort        = {Order Book},
  description = {termo em inglês para livro de ofertas. É a estrutura que organiza intenções de compra e venda por preço e quantidade, permitindo identificar melhor compra, melhor venda, \textit{spread}, profundidade e desbalanceamento de mercado}
}
