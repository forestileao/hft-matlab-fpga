...
\usepackage{xspace}
\usepackage[section]{placeins} % impede que figuras atravessem a seção em que são discutidas
...
\newcommand{\codigo}[1]{\texttt{\detokenize{#1}}}%% Código inline com caracteres especiais
\newcommand{\repoarquivo}[1]{\href{https://github.com/forestileao/hft-matlab-fpga/blob/main/#1}{\codigo{#1}}}%% Link para arquivo no repositório público
\newcommand{\repocodigo}[2]{\href{https://github.com/forestileao/hft-matlab-fpga/blob/main/#2}{\codigo{#1}}}%% Link para artefato de código com rótulo curto
\newcommand{\repomake}[1]{\href{https://github.com/forestileao/hft-matlab-fpga/blob/main/Makefile}{\codigo{make #1}}}%% Link para alvo do Makefile
...
% Compatibilidade com TeX Live recente: arquivos .toc antigos do template podem
% conter \MakeTextUppercase com argumento opcional. Como os capítulos em caixa
% alta foram desativados, a macro abaixo apenas preserva o texto ao reler o .toc.
\renewcommand{\MakeTextUppercase}[2][]{#2}
\makeatletter
...
% \makenoidxglossaries
% O pacote glossaries e \makeglossaries já são carregados pela classe utfpr e
% pelo main.tex. Recarregar aqui causa comportamento instável na lista de siglas.
% Como a lista de siglas é impressa manualmente, os links automáticos do
% glossaries são desativados para evitar destinos ausentes no PDF.
\glsdisablehyper
